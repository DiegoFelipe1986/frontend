...
const PRIORITY = ['To do','In progress', 'In QA', 'Done', 'Deployed'];
...
const ModalFormTask = () => {
    ...
    useEffect(() => {
        if (task?._id) {
            ...
            setDeliverDate(task.dateDelivery?.split('T')[0]);
    ...
    const handleSubmit = async e => {
        ...
        await submitTask({id, name, description, priority, deliverDate, project: params.id});
                            ...
                            <div className="sm:flex sm:items-start">
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    ...
                                    >
                                        ...
                                        <input
                                            type="submit"
                                            className='bg-sky-600 bg-sky-700 w-full p-3 text-white uppercase font-bold cursor-pointer transition-colors rounded'
                                            value='save'
                                        />
                                    </form>
                                </div>
